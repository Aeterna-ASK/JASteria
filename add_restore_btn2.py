...
template_inject = """<template>
  <div class="animate-fade-in">"""
new_template = """<template>
  <div class="animate-fade-in">
    <div style="background-color: #ffeaea; padding: 10px; text-align: center; border-bottom: 2px solid red;" class="no-print">
      <button @click="forceRestoreBagnaCauda" style="background: red; color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; font-size: 16px;">
        【緊急】バーニャカウダ完全復旧を実行
      </button>
    </div>"""
