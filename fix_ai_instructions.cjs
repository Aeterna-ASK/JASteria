...
const regex = /const generateInstructionsOnlyWithAi = async \(\) => \{[\s\S]*?isGeneratingInstructions\.value = false;\n  \}\n\};/g;
...
console.log("Successfully fixed generateInstructionsOnlyWithAi.");
