...
# I will inject the function just before `export const restaurantStore = readonly({`
inject_point = "export const restaurantStore = readonly({"
...
if inject_point in store_text:
    store_text = store_text.replace(inject_point, new_store_func)
